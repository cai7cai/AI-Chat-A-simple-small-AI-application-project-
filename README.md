...
- 💬 **好友人设对话** – 内置系统提示，AI 以温柔贴心的好友身份与用户聊天，风格自然、情绪同步。
- 🧠 **本地模型支持** – 通过 Ollama 调用 `qwen2.5:1.5b` 等本地模型，无需联网，隐私安全（可自行查阅资料配置其他模型）。
- 📚 **会话管理** – 自动保存/加载聊天记录，支持新建会话、删除会话、历史会话列表。
- 🎨 **个性化设置** – 侧边栏可自定义 AI 的名字和性格描述，即刻生效。
...
欢迎提交 Issue 或 Pull Request，帮助优化项目，提升为更复杂高级的项目！
